# Apache HTTP server service for Wodby

Use Apache HTTP server as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Apache HTTP server service in the Wodby catalog.

- [Apache HTTP server service in the Wodby catalog](https://wodby.com/services/httpd)
...
4. Reference `httpd` from your stack manifest.
